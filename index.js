class AnimalTable {
    ...
    renderTable() {
      ...
      ["Species", "Name","image", "Size", "Location", "Actions"].forEach((col) => {
    ...
    deleteAnimal(index) {
      if (confirm("Are you sure you want to delete this animal?")) {
        console.log("before", this.jsonData);
        this.jsonData.splice(index, 1); // Remove animal from the lis
        console.log("after", this.jsonData);
  ...
  const bigCatsData = [
    ...
    { species: "Big Cats", name: "Caracal",
      image:
      "https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/sheep-5.jpg", size: 3, location: "Africa" },
    { species: "Big Cats", name: "Jaguar",    image:
      "https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/sheep-5.jpg", size: 5, location: "Amazon" },
  ]; // Big Cats JSON
  const dogsData = [
    {
      species: "Dog",
  ...
  const bigFishData = [
    ...
    },
    {
      species: "Big Fish",
      name: "Tiger Shark",
      image:"https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/sheep-5.jpg",
      size: 8,
      location: "Ocean",
    },
    {
